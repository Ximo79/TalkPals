...
export class GameScene extends Phaser.Scene {
  ...
  preload() {
    this.load.image('mapa', 'assets/map_1_court.png');      // desde /public/assets
    this.load.image('breijo', 'assets/sprite_1_front.png'); // desde /public/assets
  }
  ...
  private layout() {
    ...
    // escala del sprite proporcional al mapa (~14% del alto)
    ...
    // posición inicial centrada baja
